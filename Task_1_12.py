...
teacher_assistant_accuracy = train_and_evaluate(teacher_assistant_model, train_images, tf.keras.utils.to_categorical(train_labels), test_images, tf.keras.utils.to_categorical(test_labels))
