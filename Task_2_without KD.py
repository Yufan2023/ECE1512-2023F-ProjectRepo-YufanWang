...
# teacher_accuracy = train_and_evaluate_without_kd(teacher_model, train_images, train_labels_one_hot, val_images, val_labels_one_hot, test_images, tf.keras.utils.to_categorical(test_labels_encoded), model_name="teacher_model.h5")

# Train and evaluate the student model without KD
student_model_name = "student_model_without_kd.h5"
student_accuracy = train_and_evaluate_without_kd(student_model, train_images, tf.keras.utils.to_categorical(train_labels_encoded), test_images, tf.keras.utils.to_categorical(test_labels_encoded), model_name=student_model_name)
